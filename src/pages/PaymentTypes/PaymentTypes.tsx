...
import { PaymentTypesEntry, type PaymentType } from "./index";

export function PaymentTypes() {
  const queryClient = useQueryClient();

  const { getPaymentTypes, deletePaymentType } = useProvider();
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [currentType, setCurrentType] = useState<Partial<PaymentType>>({});
  ...
  return (
    <PageContainer>
      ...
      <DataTable
        columns={columns}
        data={paymentTypes as PaymentType[]}
        isLoading={isLoading}
      />
